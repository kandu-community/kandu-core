...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Stock_Movement.Product'
        db.delete_column(u'forms_stock_movement', 'Product')

        # Adding field 'Stock_Movement.Product_Variant'
        db.add_column(u'forms_stock_movement', 'Product_Variant',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Stock_Movement.Product'
        db.add_column(u'forms_stock_movement', 'Product',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'Stock_Movement.Product_Variant'
        db.delete_column(u'forms_stock_movement', 'Product_Variant')
