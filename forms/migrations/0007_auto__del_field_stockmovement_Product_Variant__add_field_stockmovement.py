...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StockMovement.Product_Variant'
        db.delete_column(u'forms_stockmovement', 'Product_Variant')

        # Adding field 'StockMovement.Product'
        db.add_column(u'forms_stockmovement', 'Product',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StockMovement.Product_Variant'
        db.add_column(u'forms_stockmovement', 'Product_Variant',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'StockMovement.Product'
        db.delete_column(u'forms_stockmovement', 'Product')
