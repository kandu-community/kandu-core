...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'simple_form.gender'
        db.alter_column(u'forms_simple_form', 'gender', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'simple_form.gender'
        db.alter_column(u'forms_simple_form', 'gender', self.gf('django.db.models.fields.CharField')(max_length=5))
