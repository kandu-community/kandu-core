...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'forms_stock')

        # Adding model 'qholloi_stock'
        db.create_table(u'forms_qholloi_stock', (
        ...
        db.send_create_signal(u'forms', ['qholloi_stock'])

        # Adding model 'marlinf_stock'
        db.create_table(u'forms_marlinf_stock', (
            (u'baseformmodel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['forms.BaseFormModel'], unique=True, primary_key=True)),
            ('Product', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('Quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'forms', ['marlinf_stock'])


    def backwards(self, orm):
        # Adding model 'Stock'
        db.create_table(u'forms_stock', (
            ('Product', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            (u'baseformmodel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['forms.BaseFormModel'], unique=True, primary_key=True)),
            ('Quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'forms', ['Stock'])

        # Deleting model 'qholloi_stock'
        db.delete_table(u'forms_qholloi_stock')

        # Deleting model 'marlinf_stock'
        db.delete_table(u'forms_marlinf_stock')
    ...
    models = {
        ...
        u'forms.marlinf_stock': {
            'Meta': {'object_name': 'marlinf_stock', '_ormbases': [u'forms.BaseFormModel']},
        ...
        u'forms.qholloi_stock': {
            'Meta': {'object_name': 'qholloi_stock', '_ormbases': [u'forms.BaseFormModel']},
            'Product': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'Quantity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'baseformmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['forms.BaseFormModel']", 'unique': 'True', 'primary_key': 'True'})
        }
