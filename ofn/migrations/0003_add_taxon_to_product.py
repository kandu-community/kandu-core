...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.primary_taxon_id'
        db.add_column(u'ofn_product', 'primary_taxon_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.primary_taxon_id'
        db.delete_column(u'ofn_product', 'primary_taxon_id')
    ...
    models = {
        ...
        u'ofn.product': {
            ...
            'primary_taxon_id': ('django.db.models.fields.IntegerField', [], {}),
