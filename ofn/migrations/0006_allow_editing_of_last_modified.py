...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.last_modified'
        db.alter_column(u'ofn_product', 'last_modified', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Product.last_modified'
        db.alter_column(u'ofn_product', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
