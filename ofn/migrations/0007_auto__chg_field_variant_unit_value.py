...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variant.unit_value'
        db.alter_column(u'ofn_variant', 'unit_value', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Variant.unit_value'
        db.alter_column(u'ofn_variant', 'unit_value', self.gf('django.db.models.fields.FloatField')(default=0))
