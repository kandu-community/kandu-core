...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Variant.unit_description'
        db.delete_column(u'ofn_variant', 'unit_description')

        # Deleting field 'Variant.sku'
        db.delete_column(u'ofn_variant', 'sku')

        # Deleting field 'Variant.unit_value'
        db.delete_column(u'ofn_variant', 'unit_value')

        # Adding field 'Variant.full_name'
        db.add_column(u'ofn_variant', 'full_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Variant.unit_description'
        db.add_column(u'ofn_variant', 'unit_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Variant.sku'
        db.add_column(u'ofn_variant', 'sku',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Variant.unit_value'
        db.add_column(u'ofn_variant', 'unit_value',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Deleting field 'Variant.full_name'
        db.delete_column(u'ofn_variant', 'full_name')
